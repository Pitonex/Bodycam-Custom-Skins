...
## ⚠️ Важное предупреждение (мультиплеер)

> [!WARNING]
> Модификация является **клиентской**.  
> Игроки, у которых **не установлен** этот мод, будут видеть на вас стандартный (базовый/стартовый) скин. Чтобы другие игроки видели ваши кастомные скины, у них также должен быть установлен данный мод.
```
